...
|-----------|-------------|
| **Editores de Texto** | `ArchbaseEdit`, `ArchbaseTextArea`, `ArchbasePasswordEdit`, `ArchbasePasswordStrengthMeter`, `ArchbaseMaskEdit` |
...
| Componente | Descrição |
|------------|-----------|
| `UserModal` | Modal de cadastro de usuário |
