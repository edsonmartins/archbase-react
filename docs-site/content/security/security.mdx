...
│  - useArchbaseSecurity, useArchbaseSecureForm               │
│  - ArchbaseSecurityProvider, ArchbaseViewSecurityProvider   │
└─────────────────────────────────────────────────────────────┘
                              ↓
┌─────────────────────────────────────────────────────────────┐
│  Camada 3: Serviços & Managers                               │
│  - ArchbaseAuthenticator (interface)                        │
│  - ArchbaseSecurityManager                                   │
│  - ArchbaseTokenManager                                      │
