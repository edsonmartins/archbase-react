...
import { UserRemoteService } from './UserRemoteService'
import { GroupRemoteService } from './GroupRemoteService'
import { ResourceRemoteService } from './ResourceRemoteService'
...
export function ArchbaseSecurityManager({
  ...
  const userApi = useArchbaseRemoteServiceApi<UserRemoteService>(ARCHBASE_IOC_API_TYPE.User)
  const groupApi = useArchbaseRemoteServiceApi<GroupRemoteService>(ARCHBASE_IOC_API_TYPE.Group)
  const resourceApi = useArchbaseRemoteServiceApi<ResourceRemoteService>(ARCHBASE_IOC_API_TYPE.Resource)
