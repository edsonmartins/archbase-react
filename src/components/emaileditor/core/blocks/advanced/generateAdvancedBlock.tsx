...
import { createCustomBlock } from '@emaileditor/core/utils/createCustomBlock';
import { TemplateEngineManager } from '@emaileditor/core/utils';
...
export enum EmailOperatorSymbol {
  AND = 'and',
  OR = 'or',
}
