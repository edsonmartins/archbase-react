import { AdvancedBlock, EmailOperator } from '@emaileditor/core/blocks/advanced/generateAdvancedBlock';
import { Raw } from '@emaileditor/core/components';
...
function generateConditionTemplate(
  ...
  const generateExpression = (condition: {
    ...
    if (condition.operator === EmailOperator.TRUTHY) {
      return condition.left;
    }
    if (condition.operator === EmailOperator.FALSY) {
