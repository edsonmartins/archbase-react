...
const Tabs: React.FC<TabsProps> = props => {
  ...
  return (
    ...
    >
      <div className='archbase-email-editor-tabWrapper'>
        <Stack
                ...
                return (
                  <div
                    ...
                    className={classnames(
                      'archbase-email-editor-tabItem',
                      !activeTab && index === 0 && 'archbase-email-editor-tabActiveItem',
                      activeTab === item.key && 'archbase-email-editor-tabActiveItem',
                    )}
                  >
                    <Button noBorder>
                      <>{item.props.tab}</>
