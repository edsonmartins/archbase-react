...
class ArchbaseFilterSelectRange extends Component<ArchbaseFilterSelectRangeProps, ArchbaseFilterSelectRangeState> {
  ...
  componentWillReceiveProps = (_nextProps: ArchbaseFilterSelectRangeProps) => {
  ...
  render = () => {
    return (
      ...
      >
        ...
        >
          <Button onClick={() => this.props.onConfirmSelectRange!(this.state.value)}>Aplicar</Button>
          <Button color="red" onClick={this.props.onCancelSelectRange}>
            Cancela
          </Button>
        </Box>
      </Modal>
