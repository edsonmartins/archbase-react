...
import { IconArrowUp, IconSearch, IconTrash, IconArrowDown } from '@tabler/icons-react'
...
> {
  ...
  UNSAFE_componentWillReceiveProps = (nextProps: CustomSortItemProps<T, ID>) => {
    this.setState({ update: Math.random(), selected: nextProps.recordData.selected })
  }
    ...
    return (
      ...
      >
        ...
        <div>
          ...
          <i
            className={this.isAsc() ? 'fa fa-arrow-left' : 'fa fa-sort-alpha-up'}
            style={{ cursor: 'pointer' }}
            onDoubleClick={this.onDoubleClick}
          />
        </div>
