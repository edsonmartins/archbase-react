...
import { Avatar, Button, Card, Grid, Group, Text, createStyles } from '@mantine/core';
      ...
      <Grid.Col span="content">
        <Card shadow="sm" padding="lg" radius="md" withBorder>
          ...
          <ArchbaseList<Pessoa, string>
            ...
            onSelectListItem={(index, data) => setActiveIndex(index)}
          />
        </Card>
        <Button onClick={() => dataSource.next()}>Próximo registro</Button>
      </Grid.Col>
      <Grid.Col span={3}>
        <Card shadow="sm" padding="lg" radius="md" withBorder>
          <Card.Section withBorder inheritPadding py="xs">
