...
import { hasOwnProperty } from '@components/core/utils/objectPrototype';
import { getPropertyValue } from '@components/core/utils/propertyUtils';
 ...
 */
export const ArchbaseObjectPreview: FC<any> = ({ data }) => {
