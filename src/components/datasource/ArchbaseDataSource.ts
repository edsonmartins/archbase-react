...
import { ArchbaseDataSourceError } from '@components/core/exceptions';
...
export class ArchbaseDataSource<T, _ID> implements IDataSource<T> {
  ...
  protected validateDataSourceActive(operation: string) {
    if (!this.isActive()) {
      throw new ArchbaseDataSourceError(i18next.t('operationNotAllowed', { dataSourceName: this.name, operation }));
    }
  }

  public clear(): void {
    if (!this.isActive()) {
      throw new ArchbaseDataSourceError(i18next.t('operationNotAllowed', { dataSourceName: this.name, operation: 'clear' }));
    }
  ...
  public open(options: DataSourceOptions<T>): void {
    if (this.isActive()) {
      throw new ArchbaseDataSourceError(i18next.t('operationNotAllowed', { dataSourceName: this.name, operation: 'open' }));
    }
  ...
  public append(record: T): number {
    ...
    if (this.inserting || this.editing) {
      throw new ArchbaseDataSourceError(i18next.t('insertRecordIsNotAllowed', { dataSourceName: this.name }));
    }
  ...
  public edit(): this {
    ...
    if (this.inserting || this.editing) {
      throw new ArchbaseDataSourceError(i18next.t('editRecordIsNotAllowed', { dataSourceName: this.name }));
    }
  ...
  public cancel(): this {
    ...
    if (!this.inserting || !this.editing) {
      throw new ArchbaseDataSourceError(i18next.t('notAllowCancelRecord', { dataSourceName: this.name }));
    }
  ...
  public setFieldValue(fieldName: string, value: any): this {
    ...
    if (!(this.inserting || this.editing || this.isBOF() || this.isEOF())) {
      throw new ArchbaseDataSourceError(i18next.t('recordNotBeingEdited', { dataSourceName: this.name }));
    }
  ...
  public addFieldChangeListener(fieldName: string, listener: (fieldName: string, oldValue: any, newValue: any) => void): this {
  ...
  public removeFieldChangeListener(fieldName: string, listener: (fieldName: string, oldValue: any, newValue: any) => void): this {
