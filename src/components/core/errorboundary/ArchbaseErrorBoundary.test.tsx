...
describe("ArchbaseErrorBoundary", () => {
  ...
  describe('"fallback" element', () => {
    function render(
      props: Omit<ArchbaseErrorBoundaryPropsWithFallback, "fallback"> = {}
    ) {
      act(() => {
        root.render(
  ...
  describe('"FallbackComponent"', () => {
    ...
    function render(
      props: Omit<ArchbaseErrorBoundaryPropsWithComponent, "FallbackComponent"> = {}
    ) {
      act(() => {
        root.render(
  ...
  describe('"fallbackRender" render prop', () => {
    ...
    function render(
      props: Omit<ArchbaseErrorBoundaryPropsWithRender, "fallbackRender"> = {}
    ) {
      act(() => {
        root.render(
