...
export class ArchbaseErrorBoundary extends Component<
  ArchbaseErrorBoundaryProps,
  ArchbaseErrorBoundaryState
> {
  ...
  componentDidUpdate(
    prevProps: ArchbaseErrorBoundaryProps,
    prevState: ArchbaseErrorBoundaryState
  ) {
  ...
  render() {
    const { children, fallbackRender, FallbackComponent, fallback, othersProps } =
      this.props;
    ...
    if (didCatch) {
      ...
      if (isValidElement(fallback)) {
        ...
        childToRender = createElement(FallbackComponent, props);
          ...
          console.error(
            "ArchaseErrorBoundary requer um fallback, fallbackRender, ou FallbackComponent"
          );
