  ...
  return (
    <div style={{ width: '100%', height: 'calc(100vh - 50px)' }}>
      <ArchbaseAdminMainLayout
        ...
        navigationRootLink="/"
        footer={<ArchbaseAdminLayoutFooter></ArchbaseAdminLayoutFooter>}
        header={
...
export default {
  ...
  component: ArchbaseAdminMainLayoutExample,
} as Meta;

export const Example: StoryObj<typeof ArchbaseAdminMainLayoutExample> = {
  args: {
    render: () => {
      <ArchbaseAdminMainLayoutExample />;
    },
  },
};
