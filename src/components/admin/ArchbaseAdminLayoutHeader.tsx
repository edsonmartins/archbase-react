...
import { ArchbaseColorSchemeAction } from './ArchbaseActionSchemeAction';
import { IconSearch } from '@tabler/icons-react';
import { SpotlightAction, SpotlightActionProps, SpotlightProvider, spotlight } from '@mantine/spotlight';
...
function CustomCommand({ action, styles, classNames, hovered, onTrigger, ...others }: SpotlightActionProps) {
  ...
  return (
    ...
    >
      <Group noWrap>
        {action.category && <Badge color={action.color.backgroundColor}>{action.category}</Badge>}
        {action.image && (
          <Center>
