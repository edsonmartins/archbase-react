...
# Pack Only Script for Archbase React v3
# This script only packages already built packages (faster for re-packaging)

set -e  # Exit on any error

echo "📦 Starting Archbase React v3 packaging process..."
...
rm -f dist-packages/archbase-*.tgz
