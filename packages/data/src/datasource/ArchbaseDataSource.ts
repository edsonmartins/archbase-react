...
// Interfaces moved to @archbase/core to avoid circular dependencies
// export type DataSourceValidationError - now imported from @archbase/core
// export interface IDataSourceValidator - now imported from @archbase/core

// Re-export interfaces from @archbase/core for backward compatibility
