...
import './ArchbaseCropper.scss';

export const ArchbaseCropperWrapper = memo(({ src, size, croppUpdate }:
  {
    src: string,
    size: any,
  ...
  const mount = useRef<HTMLImageElement | undefined | null>(null);
  ...
  return <div className='ArchbaseCropprWrapper'>
