...
const ArchbaseMasonryResponsiveExample = () => {
  return (
    <Grid>
      <Grid.Col span={12}>
        <Card shadow="sm" padding="lg" radius="md" withBorder>
...
const meta: Meta<typeof ArchbaseMasonry> = {
  ...
  parameters: {
    docs: {
      description: {
        component: `
O ArchbaseMasonry é um componente de layout estilo Pinterest/Masonry.

## Características
- Layout em colunas com altura dinâmica
- Número de colunas configurável
- Espaçamento (gutter) customizável
- Versão responsiva com breakpoints
        `,
      },
    },
  },
...
export const Responsivo: Story = {
  name: 'Responsivo',
  render: () => <ArchbaseMasonryResponsiveExample />,
};
