...
export declare function ArchbaseThemeEditor<T, ID>({ dataSource, dataField, value, onChangeValue, disabled, readOnly, ...props }: ArchbaseThemeEditorProps<T, ID>): import("react/jsx-runtime").JSX.Element;
//# sourceMappingURL=ArchbaseThemeEditor.d.ts.map