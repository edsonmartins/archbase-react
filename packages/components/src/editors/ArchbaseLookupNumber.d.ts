...
export declare function ArchbaseLookupNumber<T, ID, O>({ dataSource, dataField, lookupField, iconSearch, disabled, readOnly, style, placeholder, label, description, error, required, size, width, value, lookupValueDelegator, onLookupError, onLookupResult, validateMessage, tooltipIconSearch, validateOnExit, onFocusExit, onFocusEnter, onChangeValue, onActionSearchExecute, innerRef, decimalSeparator, thousandSeparator, precision, allowNegative, allowEmpty, }: ArchbaseLookupNumberProps<T, ID, O>): import("react/jsx-runtime").JSX.Element;
//# sourceMappingURL=ArchbaseLookupNumber.d.ts.map